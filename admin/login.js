// Credenciales de acceso (en producción, esto debería estar en el servidor)
...
// Inicializar elementos del login
...
function checkExistingSession() {
    ...
    if (isAuthenticated === 'true' && sessionExpiry) {
        ...
        if (now < parseInt(sessionExpiry)) {
            // Sesión válida, redirigir al backoffice
...
// Prevenir acceso directo al backoffice sin autenticación
